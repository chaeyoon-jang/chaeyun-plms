...
parser.add_argument('--dir', type=str, default='/mnt/home/chaeyun-jang/roberta/ckpt/', metavar='DIR',
                    help='training directory (default: None)')

args = parser.parse_args()

file = np.load(os.path.join(args.dir, 'rte_plane.npz'))
...
plt.savefig(os.path.join(args.dir, 'train_loss_plane.png'))
